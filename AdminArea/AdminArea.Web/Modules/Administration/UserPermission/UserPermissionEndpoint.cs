using MyRepository = AdminArea.Administration.Repositories.UserPermissionRepository;
using MyRow = AdminArea.Administration.UserPermissionRow;

namespace AdminArea.Administration.Endpoints;
